...
interacts between variables that could also be affecting the model's performance.  
Again, these additions are in addition to the aspects that were already apart 
...
models stayed around this level of accuracy. It was surprising
...
$k$-nearest neighbors models, and random forest models,
while also I did not expect for both of my neural network models to perform s
so well in comparison to the others. This is because I have never
used them before, so I was unaware going in on how they performed usually. 
I feel it would be interesting to go back in the future and look at these 
...
its scalability and flexibility in the type of data it receives help to make it 
...
able to dial more into what works and what doesn't, hopefully creating a completely
or close to completely accurate model. As I felt that in terms of how I picked
my tuning parameters it was not the most reliable methods, but rather I focused
